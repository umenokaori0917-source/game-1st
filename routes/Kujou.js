...
　　choices:[{label:"図書館で続きを聞くことを提案する", next:"K2_prelude"}]
  ...
  S["K1_ignore2"] = {
    name:"",
    text:"振り向くと、そこには篠宮 奏。彼女は私を背に庇うように九条との間に入った。",
    next:"K1_ignore3",
  ...
  S["K1_ignore4"] = {
    name:"",
    text:"奏の警戒心を特に気にすることもなく、九条は短く頷く。\nファイルの端を綺麗に整えて、また鞄へしまった。",
    next:"K1_ignore5",
  ...
  S["K1_ignore6"] = {
    name:"澪",
    text:"(助かった——けど、これで終わるはずがない)",
    choices:[{label:"少し落ち着いてから向き合う決意をする", next:"K1_ignore7"}]
  };
  
  S["K1_ignore7"] = {
    name:"澪",
    text:"「奏、ありがとう。でも大丈夫だよ」",
    next:"K1_ignore8",
  };
  ...
  S["K1_ignore9"] = {
    name:"",
    text:"奏はそれ以上何も言おうとしなかった。\n私が覚悟を決めているとわかったのだろう。\n心配そうな視線を投げではくるが、私の選択を彼女は尊重してくれた。\n彼女は本当に私を思ってくれている優しい友人だ。",
    next:"K1_ignore10",
  };
  ...
  S["K1_ignore10"] = {
    name:"澪",
    text:"「……では行きましょう。九条さん」",
    choices:[{label:"九条についていく", next:"K2_prelude"}]
  };
